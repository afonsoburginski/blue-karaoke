    ...
    <header className="fixed top-0 left-0 right-0 z-20 flex items-center justify-between px-6 py-4 md:px-12">
      ...
      <nav className="hidden items-center gap-1 lg:flex">
        <div className="flex items-center rounded-full bg-white/10 backdrop-blur-sm px-1 py-1">
          ...
          <Link href="/#planos" className="px-4 py-2 text-sm text-white hover:text-white/80 transition-colors">Preço</Link>
          <Link href="/#como-funciona" className="px-4 py-2 text-sm text-white hover:text-white/80 transition-colors">Como Funciona</Link>
